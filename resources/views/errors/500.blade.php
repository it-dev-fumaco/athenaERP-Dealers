            ...
            <div class="row mt-5">
                <div class="col-md-8 offset-md-2">
                    <div class="row m-5">
                        ...
                        <div class="col-md-8">
                            <p style="color:#001F3F !important; font-size:1.3rem !important; margin: 0;">Oops! Something went wrong in our servers.</p>
                            <p style="color:#58595A !important; font-size:0.95rem !important; margin: 0;">The server encountered an internal server error or misconfiguration and was unable to complete your request.</p><br>
